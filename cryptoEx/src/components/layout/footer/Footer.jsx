  ...
  return (
    <footer className="footer">
      <Container className="footer__container">
        <Grid container alignItems='flex-start' sx={{ paddingBottom: '40px' }} className="footer__grid">
          <Grid size={{ md: 2, sm: 12, xs: 12 }} sx={{ margin: '0 auto' }} className="footer__logo">
            <Link to="/">
          ...
          <Grid size={{ md: 4, sm: 12, xs: 12 }} className="footer__section">
            <h2 style={{ position: 'sticky', top: 0 }}>Ссылки</h2>
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: '15px', marginTop: '15px' }} className="footer__links">
              <MUILink component={Link} to='/' underline="hover" color='black'>Купить валюту</MUILink>
              <MUILink component={Link} to='https://t.me/hurricane751' target="_blank" underline="hover" color='black'>Связаться с нами</MUILink>
            </Box>
          </Grid>
          <Grid size={{ md: 4, sm: 12, xs: 12 }} className="footer__section">
            <h2 style={{ position: 'sticky', top: 0 }}>Информация</h2>
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: '15px', marginTop: '15px' }} className="footer__links">
              <MUILink component={Link} to='/privacy' underline="hover" color='black'>Политика конфиденциальности</MUILink>
              <MUILink component={Link} to='/aml-kyc' underline="hover" color='black'>AML/KYC Политика</MUILink>
            </Box>
          </Grid>
        </Grid>
      </Container>
